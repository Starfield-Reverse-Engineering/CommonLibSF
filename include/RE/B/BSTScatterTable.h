...
namespace RE
{
	...
	template <>
	class BSTScatterTableDefaultHashPolicy<BSFixedString>
	{
	public:
		size_t operator()(const BSFixedString& key)
		{
	...
	template <>
	class BSTScatterTableDefaultHashPolicy<BSFixedStringCS>
	{
	public:
	...
	template <>
	class BSTScatterTableDefaultHashPolicy<BSFixedStringW>
	{
	public:
		size_t operator()(const BSFixedStringW& key)
		{
	...
	template <>
	class BSTScatterTableDefaultHashPolicy<BSFixedStringWCS>
	{
	public:
		size_t operator()(const BSFixedStringW& key)
		{
	...
	template <>
	class BSTScatterTableDefaultHashPolicy<uint32_t>
	{
	public:
		size_t operator()(const uint32_t& key)
		{
