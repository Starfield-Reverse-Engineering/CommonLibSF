...
namespace RE
{
	BGSLocation* TESObjectREFR::GetCurrentLocation()
	{
		...
		REL::Relocation<func_t> func{ Offset::TESObjectREFR::GetCurrentLocation };
		return func(this);
	}
	...
	TESObjectREFR* TESObjectREFR::GetLinkedRef(BGSKeyword* a_keyword)
	{
		...
		REL::Relocation<func_t> func{ Offset::TESObjectREFR::GetLinkedRef };
	...
	TESWorldSpace* TESObjectREFR::GetParentWorldSpace()
	{
		...
		REL::Relocation<func_t> func{ Offset::TESObjectREFR::GetParentWorldSpace };
		return func(this);
	}
	...
	TESObjectREFR* TESObjectREFR::GetSpaceship(bool a_arg1)
	{
		...
		REL::Relocation<func_t> func{ Offset::TESObjectREFR::GetSpaceship };
	...
	TESObjectREFR* TESObjectREFR::GetSpaceshipParentDock()
	{
		...
		REL::Relocation<func_t> func{ Offset::TESObjectREFR::GetSpaceshipParentDock };
		return func(this);
	}
	...
	Actor* TESObjectREFR::GetSpaceshipPilot()
	{
		...
		REL::Relocation<func_t> func{ Offset::TESObjectREFR::GetSpaceshipPilot };
		return func(this);
	}
	...
	std::int32_t TESObjectREFR::GetValue()
	{
		...
		REL::Relocation<func_t> func{ Offset::TESObjectREFR::GetValue };
		return func(this);
	}
	...
	bool TESObjectREFR::HasKeyword(BGSKeyword* a_keyword)
	{
		...
		REL::Relocation<func_t> func{ Offset::TESObjectREFR::HasKeyword };
		return func(this, a_keyword);
	}
	...
	bool TESObjectREFR::IsInSpace(bool a_arg1)
	{
		...
		REL::Relocation<func_t> func{ Offset::TESObjectREFR::IsInSpace };
		return func(this, a_arg1);
	}
	...
	bool TESObjectREFR::IsSpaceshipDocked()
	{
		...
		REL::Relocation<func_t> func{ Offset::TESObjectREFR::IsSpaceshipDocked };
		return func(this);
	}
	...
	bool TESObjectREFR::IsSpaceshipLanded()
	{
		...
		REL::Relocation<func_t> func{ Offset::TESObjectREFR::IsSpaceshipLanded };
		return func(this);
	}
