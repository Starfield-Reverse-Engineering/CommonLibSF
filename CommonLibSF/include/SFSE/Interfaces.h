...
namespace SFSE
{
	...
	public:
		...
		constexpr void UsesSigScanning(bool a_value) noexcept { addressIndependence = 1 << !a_value; }

		constexpr void UsesAddressLibrary(bool a_value) noexcept { addressIndependence = 1 << a_value; }

		constexpr void HasNoStructUse(bool a_value) noexcept { structureCompatibility = 1 << !a_value; }

		constexpr void IsLayoutDependent(bool a_value) noexcept { structureCompatibility = 1 << a_value; }
